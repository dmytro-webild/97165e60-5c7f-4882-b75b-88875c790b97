      ...
      <ReactLenis root>
        ...
        <div id="testimonial" data-section="testimonial">
          <TestimonialCardFive
            ...
            testimonials={[
              {
                id: "t1",                name: "Elena R.",                date: "2024",                title: "Art Director",                quote: "Incredible eye for detail.",                tag: "Expertise",                avatarSrc: "http://img.b2bpic.net/free-photo/elegant-mature-woman-sitting-stool_23-2148275043.jpg"
              },
              {
                id: "t2",                name: "Mark S.",                date: "2024",                title: "Curator",                quote: "A master of light and shadow.",                tag: "Recognition",                avatarSrc: "http://img.b2bpic.net/free-photo/elegant-senior-woman-sitting-chair_23-2148275119.jpg"
              }
            ]}
          />
        </div>
        ...
        <div id="faq" data-section="faq">
          <FaqSplitText
            ...
            faqs={[
              {
                id: "f1",                title: "Do you accept freelance projects?",                content: "Yes, I am currently open to new collaborations."
              },
              {
                id: "f2",                title: "Where can I purchase prints?",                content: "Direct inquiries can be made via the contact form."
              }
            ]}
          />
        </div>
